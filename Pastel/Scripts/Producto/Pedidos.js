...
$(document).ready(function () {
    CargarDatosTablaPedido();
    $.fn.dataTable.ext.errMode = 'throw'
    tablaPedido = $('#TbListarPedido').dataTable({
        'bJQueryUI': true,
        'bLengthChange': true,
        'scrollCollapse': true,
        'bPaginate': true,
...
function CargarDatosTablaPedido() {
    $.ajax({
        dataType: "json",
        type: "POST",
        url: "/Producto/ListarPedidos",
        async: true,
        success: function (result) {
            LlenarDatosTablaPedido(result);
        },
...
function LlenarDatosTablaPedido(respuesta) {
    tablaPedido.fnClearTable();
    tablaPedido.fnAddData(respuesta);
}